...
import { cancelOrder, createOrder, createOrderCard, getAllOrders, updateOrderStatusByAdmin } from "./order.controller.js";

const orderRouter = Router();

orderRouter.get("/", auth(endPoint.user), asyncHandle(getAllOrders));
